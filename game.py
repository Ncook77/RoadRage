...
# road hazard is touched. The object of the game is to get the highest score possible. Score is a function of a timer
# and coins collected (each coin is worth 100 timer points).
